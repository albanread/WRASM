...
use crate::diagrams::flowchart::ArrowHead;
...
/// Get the marker URL for an explicit arrowhead override.
pub fn get_override_marker_url(arrow_head: ArrowHead, is_start: bool) -> Option<String> {
    match (arrow_head, is_start) {
        (ArrowHead::None, _) => None,
        (ArrowHead::Point, false) => Some("url(#arrow_point)".to_string()),
        (ArrowHead::Point, true) => Some("url(#arrow_point_start)".to_string()),
        (ArrowHead::Circle, false) => Some("url(#arrow_circle)".to_string()),
        (ArrowHead::Circle, true) => Some("url(#arrow_circle_start)".to_string()),
        (ArrowHead::Cross, false) => Some("url(#arrow_cross)".to_string()),
        (ArrowHead::Cross, true) => Some("url(#arrow_cross_start)".to_string()),
    }
}
